    ...
    <div className="min-h-screen bg-white text-[#07372F] overflow-hidden">
      ...
      <main className="pt-[2px]">
        ...
        <section className="relative bg-gradient-to-br from-[#E8FFF5] via-[#F4FFFA] to-[#E5F8EF] border-b border-[#D8EEE5]">
          <div className="max-w-[1400px] mx-auto px-8 lg:px-12 py-8 lg:py-11">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-8 lg:gap-12 items-center">
              ...
              <div className="max-w-[700px] animate-[fadeUp_.7s_ease-out_both]">
                <p className="uppercase tracking-[2px] text-[12px] lg:text-[13px] font-bold text-[#3F9975] mb-3">{data.hero.label}</p>
              ...
              <div className="relative group animate-[fadeUp_.7s_.15s_ease-out_both]">
                <div className="relative overflow-hidden rounded-[24px] border border-[#D2EBE1] shadow-[0_15px_40px_rgba(4,70,55,0.10)] transition-all duration-500 group-hover:shadow-[0_22px_50px_rgba(4,70,55,0.18)]">
                  <img src={heroImage} alt="What Makes Us Different" className="w-full h-[260px] sm:h-[320px] lg:h-[350px] object-cover transition-transform duration-700 group-hover:scale-[1.025]" />
        ...
        <section className="py-14 lg:py-18 bg-white">
          <div className="max-w-[1350px] mx-auto px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="group relative overflow-hidden bg-gradient-to-br from-[#005B49] to-[#004D3F] rounded-[24px] p-8 lg:p-10 min-h-[350px] shadow-[0_15px_40px_rgba(0,91,73,0.14)] hover:-translate-y-2 hover:shadow-[0_25px_50px_rgba(0,91,73,0.22)] transition-all duration-500 animate-[fadeUp_.7s_.15s_ease-out_both]">
              ...
              <div className="animate-[fadeUp_.7s_.3s_ease-out_both]">
                ...
                <div className="mt-6 space-y-2">
                  ...
                  {data.exploreItems.map((item, index) => {
                    ...
                    return (
                      <div key={index} style={{ animationDelay: `${index * 100}ms` }} className="group flex items-center gap-4 p-3 rounded-xl hover:bg-[#F1FBF6] transition-all duration-300 cursor-default animate-[fadeUp_.5s_ease-out_both]">
          ...
          <div className="max-w-[1350px] mx-auto px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              {data.approachCards.map((item, index) => {
                ...
                return (
                  <div key={index} style={{ animationDelay: `${index * 100}ms` }} className="group relative min-h-[265px] rounded-[20px] border border-[#E3ECE8] bg-white p-6 lg:p-7 shadow-[0_7px_22px_rgba(0,0,0,0.035)] hover:-translate-y-2 hover:border-[#BFE6D4] hover:bg-gradient-to-br hover:from-white hover:to-[#F2FBF7] hover:shadow-[0_18px_40px_rgba(0,91,73,0.12)] transition-all duration-400 animate-[fadeUp_.6s_ease-out_both]">
        ...
        <section className="pt-12 pb-7 lg:pt-14 lg:pb-8 bg-[#F5FBF8] border-y border-[#E4F0EB]">
          <div className="max-w-[900px] mx-auto px-8 text-center animate-[fadeUp_.7s_ease-out_both]">
          ...
          <div className="max-w-[1350px] mx-auto px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6">
              ...
              {data.solutionCards.map((item, index) => {
                ...
                return (
                  <div key={index} style={{ animationDelay: `${index * 120}ms` }} className="group relative overflow-hidden bg-[#E3F8EE] rounded-[20px] p-7 lg:p-8 min-h-[205px] border border-[#D3EFE2] hover:bg-[#D8F5E7] hover:-translate-y-1 hover:shadow-[0_16px_35px_rgba(0,91,73,0.10)] transition-all duration-400 animate-[fadeUp_.6s_ease-out_both]">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="mt-5 space-y-2">
                          ...
                          {item.items.map((point, pointIndex) => (
                            <li key={pointIndex} className="flex items-start gap-3 text-[14px] lg:text-[15px] text-[#415851]">
        ...
        <section className="py-10 lg:py-12 bg-white">
          <div className="max-w-[1350px] mx-auto px-8 lg:px-12">
            ...
            <div className="group relative overflow-hidden bg-gradient-to-r from-[#005B49] to-[#006B55] rounded-[20px] px-7 lg:px-10 py-7 lg:py-8 shadow-[0_15px_35px_rgba(0,91,73,0.14)] hover:shadow-[0_20px_45px_rgba(0,91,73,0.20)] transition-all duration-500 animate-[fadeUp_.7s_.15s_ease-out_both]">
