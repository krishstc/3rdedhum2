...
function ManagerialLeadership() {
  const programs = useMemo(() => {
    const managerialProgram = servicesData.column1.find((item) => item.folder === "ManagerialSkills");
        ...
        <div className="relative mx-auto max-w-[1250px] px-6 sm:px-8 lg:px-10">
          ...
          <div className="mb-10 animate-[fadeUp_.6s_ease-out_both] sm:mb-8">
            <p className="text-[11px] tracking-wide text-[#7B8A86] sm:text-[12px]">
              ...
              <span>Services</span>
              <span className="mx-2">›</span>
              <span className="text-[#4A8E76]">Managerial & Leadership Programs</span>
            </p>
          </div>
          ...
          <div className="relative z-10 max-w-[900px] animate-[fadeUp_.7s_ease-out_both]">
            <div className="inline-flex flex-col items-start">
              <span className="text-[12px] font-semibold tracking-[1.5px] text-[#548C78] sm:text-[13px]">LEADERSHIP & MANAGEMENT</span>
            ...
            <h1 className="mt-2 text-[38px] font-bold leading-[1.06] tracking-[-2px] text-[#07372F] sm:text-[48px] md:text-[56px] lg:text-[62px]">
              Managerial & <span className="text-[#3C9A72]">Leadership Programs.</span>
            </h1>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1250px] px-6 sm:px-8 lg:px-10">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6">
            {programs.map((program, index) => {
              ...
              const iconBackground = iconBackgrounds[index] || "bg-[#EAF7F0]";
              const iconColor = iconColors[index] || "text-[#3F9975]";
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-xl ${iconBackground} ${iconColor} transition-transform duration-300 group-hover:scale-105`}>
                      <Icon size={23} />
                    </div>
        ...
        <div className="mx-auto max-w-[1250px] px-6 sm:px-8 lg:px-10">
          <div className="relative overflow-hidden rounded-2xl bg-[#005641] px-7 py-9 animate-[fadeUp_.7s_ease-out_both] sm:px-10 sm:py-11 lg:px-14">
            ...
            <div className="relative z-10 max-w-[850px]">
              <p className="text-[12px] font-semibold tracking-[1.5px] text-[#9DE4C5]">LEADERSHIP DEVELOPMENT</p>
