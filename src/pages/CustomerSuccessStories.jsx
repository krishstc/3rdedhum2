        ...
        <section className="relative bg-gradient-to-r from-[#E8FFF5] via-[#F1FFF9] to-[#E5FAF2] border-b border-[#D7EEE5]">
          ...
          <div className="max-w-[1400px] mx-auto px-7 sm:px-10 lg:px-14 xl:px-16 pt-7 pb-8 lg:pt-8 lg:pb-9">
            ...
            <div className="flex items-center flex-wrap gap-2 text-[11px] lg:text-[12px] text-[#849590] mb-6">
              ...
              <span className="text-[#3E9271] font-medium">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.02fr_0.98fr] items-center gap-8 lg:gap-10">
              ...
              <div className="max-w-[700px]">
                ...
                <div className="inline-flex flex-col items-start">
                  ...
                  <span className="text-[12px] lg:text-[13px] uppercase tracking-[1.8px] font-bold text-[#4B9676]">
                    Client Results
                  </span>
              ...
              <div className="relative flex justify-end">
                ...
                <div className="relative w-full max-w-[620px] overflow-hidden rounded-[4px]">
                  ...
                  <img
                    ...
                    className="w-full h-[320px] sm:h-[250px] lg:h-[370px] object-cover"
                  />
              ...
              <div className="space-y-5 lg:space-y-6">
                ...
                {timelineStories.map((story) => {
                  ...
                  return (
                    ...
                    <div
                      key={story.id}
                      className="relative grid grid-cols-1 md:grid-cols-2 md:gap-7 min-h-[128px]"
                    >
                      ...
                      {isLeft && (
                        <div className="absolute right-[50%] top-1/2 hidden md:flex items-center w-[28px] translate-y-[-50%] translate-x-[-1px]">
                          ...
                          <ArrowRight
                            size={12}
                            className="absolute right-[-2px] text-[#4C9677]"
                          />
                      ...
                      {!isLeft && (
                        <div className="absolute left-[50%] top-1/2 hidden md:flex items-center w-[28px] translate-y-[-50%] translate-x-[-1px]">
                          ...
                          <ArrowRight
                            size={12}
                            className="absolute left-[-2px] rotate-180 text-[#4C9677]"
                          />
...
function TimelineCard({ story }) {
  ...
  return (
    ...
    <div
      className={`
        group relative min-h-[128px] lg:min-h-[135px]
        rounded-[8px]
        border
        px-5 sm:px-6 lg:px-7
        py-5
        shadow-[0_4px_12px_rgba(0,70,55,0.10)]
        transition-all duration-300 ease-out
        hover:-translate-y-1
        hover:scale-[1.01]
        hover:shadow-[0_12px_28px_rgba(0,91,73,0.16)]
        ${
          story.featured
            ? "bg-[#005B49] border-[#005B49] text-white hover:bg-[#006952]"
            : "bg-[#E4F8EF] border-[#D2ECE1] hover:bg-[#D7F5E8]"
        }
      `}
    >
      ...
      <div
        className={`
          absolute inset-0 rounded-[8px] opacity-0 group-hover:opacity-100
          transition-opacity duration-300 pointer-events-none
          ${
            story.featured
              ? "bg-gradient-to-r from-transparent via-[#2AA27E]/10 to-transparent"
              : "bg-gradient-to-r from-transparent via-[#B9EFD8]/35 to-transparent"
          }
        `}
      />
      ...
      <div className="relative z-10 flex items-start gap-4">
        ...
        <div
          className={`
            ...
            ${
              story.featured
                ? "bg-[#E0F8ED] text-[#08765E]"
                : "bg-white text-[#4A9877]"
            }
          `}
        >
        ...
        <div className="min-w-0 flex-1">
            ...
            <h2
              className={`
                ...
                ${
                  story.featured
                    ? "text-white"
                    : "text-[#073A35] group-hover:text-[#005B49]"
                }
              `}
            >
              {story.title}
          ...
          <div
            className={`
              mt-2 h-[2px] w-[32px] rounded-full
              transition-all duration-300
              group-hover:w-[52px]
              ${
                story.featured
          ...
          <p
            className={`
              mt-3 text-[12px] sm:text-[13px] lg:text-[13px]
              leading-[1.45]
              ${
                story.featured
                  ? "text-[#E1F6EE]"
