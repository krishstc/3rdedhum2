        ...
        <div className="relative max-w-[1400px] mx-auto px-8 py-4 flex items-center justify-between">
          ...
          <ul className="hidden lg:flex items-center gap-12 text-[18px] font-medium text-gray-700">
            ...
            >
              ...
              {/* Why Us Dropdown */}
              {activeMenu === "whyus" && (
                <ul className="absolute left-0 text-sm top-full mt-6 w-52 rounded-xl bg-white shadow-xl border py-2 z-[100]">
            ...
            >
              ...
              {/* Insights Dropdown */}
              {activeMenu === "insights" && (
                <ul className="absolute left-0 text-sm top-full mt-6 w-56 rounded-xl bg-white shadow-xl border py-2 z-[100]">
