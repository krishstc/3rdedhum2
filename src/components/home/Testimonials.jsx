    ...
    <section className="py-20 bg-[#F7F9F8]">
      <div className="max-w-[1120px] mx-auto px-6">
        ...
        <div className="relative">
          ...
          <button className="testimonial-prev absolute -left-5 top-1/2 -translate-y-1/2 hidden lg:flex z-20 w-10 h-10 rounded-full bg-white border border-gray-200 shadow-md items-center justify-center hover:bg-[#3F9975] hover:text-white transition-all duration-300">
            <FaArrowLeft size={14} />
          </button>

          {/* Next */}

          <button className="testimonial-next absolute -right-5 top-1/2 -translate-y-1/2 hidden lg:flex z-20 w-10 h-10 rounded-full bg-white border border-gray-200 shadow-md items-center justify-center hover:bg-[#3F9975] hover:text-white transition-all duration-300">
